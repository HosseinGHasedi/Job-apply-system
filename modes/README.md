...
| `regional/` | Market calibration modes — `eu-swe.md` (European SWE) and `uk-embedded.md` (UK Embedded/IoT). The UK Embedded pipeline code lives in `uk-embedded/` at the repo root. |
